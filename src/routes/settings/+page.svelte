					...
					<div class="p-4">
						...
						<div class="flex items-center justify-between">
							...
							<button
								...
								class="relative h-7 w-14 rounded-full transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 {currentTheme ===
								'dark'
									? 'bg-slate-600'
									: 'bg-stone-300'}"
							>
